...
//This is one example of a way to work around this (basically insert an element, copy to clipboard, remove element)
function fallbackCopyTextToClipboard(text) {
    var textArea = document.createElement("textarea");
...
var copyBobBtn = document.querySelector(".js-copy-btn"); //sample button to copy
