...
log(findRotatedIndex([3, 4, 1, 2], 4)); // 1
log(findRotatedIndex([4, 6, 7, 8, 9, 1, 2, 3, 4], 8)); // 3
log(findRotatedIndex([6, 7, 8, 9, 1, 2, 3, 4], 3)); // 6
log(findRotatedIndex([37, 44, 66, 102, 10, 22], 14)); // -1
log(findRotatedIndex([6, 7, 8, 9, 1, 2, 3, 4], 12)); // -1
log(findRotatedIndex([11, 12, 13, 14, 15, 16, 3, 5, 7, 9], 16)); // 5
log(findRotatedIndex([11, 12, 13, 17, 39], 17)); // 3
log(findRotatedIndex([11], 11)); // 0
log(findRotatedIndex([], 11)); // -1
log(findRotatedIndex([4, 4, 4, 4, 4], 5)); // -1
